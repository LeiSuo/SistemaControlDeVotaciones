<%-- 
    Nombre del documento   : escDepMun
    fecha                  : 24-may-2018
    Autor                  : Ulises
--%>
...
<html>
    <head>
        ...
        <title>Votos a diputados departamento y municipio</title>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="numVotDep.jsp">Numero de votantes por departamento</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li role="separator" class="divider"></li>
                                <li><a href="#">Escrutinio por departamento y municipios</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
